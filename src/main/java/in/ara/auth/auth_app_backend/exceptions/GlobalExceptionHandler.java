package in.ara.auth.auth_app_backend.exceptions;

import in.ara.auth.auth_app_backend.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handelIllegalException(IllegalArgumentException exception){
